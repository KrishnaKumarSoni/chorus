      ...
      <div className="scroll min-h-0 flex-1 px-4 pb-4">
        <section>
          <div className="flex items-center justify-between">
            <h2 id="ctx-files" className="text-caption font-semibold uppercase tracking-[0.08em]" style={{ color: 'var(--muted)' }}>Context</h2>
        ...
        <section className="mt-5">
          <h2 id="ctx-instructions" className="text-caption font-semibold uppercase tracking-[0.08em]" style={{ color: 'var(--muted)' }}>Instructions for this chat</h2>
          <textarea aria-labelledby="ctx-instructions" className="field selectable mt-2 min-h-[96px] text-meta" value={text} onChange={(e) => setText(e.target.value)}
        ...
        <section className="mt-5">
          <h2 className="text-caption font-semibold uppercase tracking-[0.08em]" style={{ color: 'var(--muted)' }}>Sessions</h2>
